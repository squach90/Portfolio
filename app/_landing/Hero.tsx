...
export const Hero = () => {
    return (
        <Section classNames="flex flex-col gap-2 lg:gap-4">
            <h1 className="text-4xl lg:text-5xl font-bold">Hey, I am Jules 👋</h1>
            <p className="text-muted-foreground">I am{" "}<Code className="whitespace-nowrap"><CustomIcons className="inline mb-0.5 mr-0.5" name="youtube" size={18} />Youtuber</Code>{" "} and I created a video about <Code>meme</Code> and <Code> aviation </Code></p>
